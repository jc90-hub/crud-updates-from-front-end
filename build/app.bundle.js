...
var _httpAsyncAwait = __webpack_require__(334);

document.addEventListener('DOMContentLoaded', getPosts);

function getPosts() {
    _httpAsyncAwait.http.get('http://localhost:3000/posts').then(function (data) {
...
var LibraryHTTP = function () {
    function LibraryHTTP() {
        _classCallCheck(this, LibraryHTTP);
    }

    _createClass(LibraryHTTP, [{
        key: 'get',
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 2:
                                ...
                                data3 = response.json();
                                return _context3.abrupt('return', data3);
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 5:
                                ...
                                return _context4.abrupt('return', data4);
...
var http = exports.http = new LibraryHTTP();
